...
const rawWorks: WorkInput[] = [
  ...
  },
  {
    ...
    description:
      "컵 표면에 다이아몬드 모양 창을 내고, 그 안에 별과 성운을 닮은 마블(대리석) 무늬를 채워 넣은 작품입니다. 1점 한정 원오리지널입니다.",
    dimensions: "지름 7cm x 높이 9cm",
    glaze: "마블 유약",
    paletteIndex: 1,
    image: "/works/product-17.jpg",
    images: ["/works/product-17-detail.jpg"],
    category: "CUPS & MUGS",
  },
  {
    id: "3",
    ...
    glaze: "마블 유약",
    paletteIndex: 2,
    image: "/works/product-18.jpg",
    images: ["/works/product-18-detail.jpg"],
    category: "CUPS & MUGS",
  },
  {
    id: "4",
    ...
    glaze: "마블 유약",
    paletteIndex: 3,
    image: "/works/product-19.jpg",
    images: ["/works/product-19-detail.jpg"],
    category: "CUPS & MUGS",
  },
];

...
const rawWorks: WorkInput[] = [
  ...
  },
  {
    ...
    price: 30000,
    shortDescription: "우연한 마블 무늬를 새긴 작은 컵 (S, 50ml)",
    description:
  ...
  },
  {
    ...
    price: 50000,
    shortDescription: "물컵으로 쓰기 좋은 마블 장식 컵 (L, 200ml)",
    description:
      "물을 담아 마시기 좋은 넉넉한 사이즈의 컵입니다. 표면을 음각으로 새기고, 그 자리에만 유색 슬립(흙물)을 마블링해 흘려 넣은 장식 기법을 썼어요. 우연히 만들어지는 흐름을 그대로 남기기 때문에, 무늬는 제품마다 조금씩 다른 정도가 아니라 완전히 달라요. 라벤더 톤 마블 무늬입니다.",
    dimensions: "Ø 70 × H 90 mm",
    capacity: "약 200 ml",
    material: "Porcelain",
    technique: "Marbled slip inlay (carved relief), drain casting",
    glaze: "Clear glaze (body) · unglazed & ground (relief inlay)",
    firing: "Oxidation firing, 1250°C",
    paletteIndex: 2,
  ...
  },
  {
    ...
    shortDescription: "물컵으로 쓰기 좋은 마블 장식 컵 (L, 200ml)",
    description:
      "물을 담아 마시기 좋은 넉넉한 사이즈의 컵입니다. 표면을 음각으로 새기고, 그 자리에만 유색 슬립(흙물)을 마블링해 흘려 넣은 장식 기법을 썼어요. 우연히 만들어지는 흐름을 그대로 남기기 때문에, 무늬는 제품마다 조금씩 다른 정도가 아니라 완전히 달라요. 블루 톤 마블 무늬입니다.",
    dimensions: "Ø 70 × H 90 mm",
    capacity: "약 200 ml",
    material: "Porcelain",
    technique: "Marbled slip inlay (carved relief), drain casting",
  ...
  },
  {
    ...
    shortDescription: "물컵으로 쓰기 좋은 마블 장식 컵 (L, 200ml)",
    description:
      "물을 담아 마시기 좋은 넉넉한 사이즈의 컵입니다. 표면을 음각으로 새기고, 그 자리에만 유색 슬립(흙물)을 마블링해 흘려 넣은 장식 기법을 썼어요. 우연히 만들어지는 흐름을 그대로 남기기 때문에, 무늬는 제품마다 조금씩 다른 정도가 아니라 완전히 달라요. 블랙 톤 마블 무늬입니다.",
    dimensions: "Ø 70 × H 90 mm",
    capacity: "약 200 ml",
    material: "Porcelain",
    technique: "Marbled slip inlay (carved relief), drain casting",

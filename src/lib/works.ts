...
const rawWorks: WorkInput[] = [
  ...
  },
  {
    ...
    paletteIndex: 1,
    image: "/works/nebula-cup-s-lavender.jpg",
    images: ["/works/nebula-cup-s-lavender.jpg"],
    category: "CUPS & MUGS",
    soldOut: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "물컵으로 쓰기 좋은 컵입니다. 유색 슬립을 마블링해 음각 부분에 흘려 넣었어요. 각각 모두 무늬가 달라, 세상에 하나뿐인 컵입니다.",
    dimensions: "Ø 70 × H 90 mm",
    capacity: "약 200 ml",
    material: "Porcelain",
    technique: "Marbled slip inlay, drain casting",
    glaze: "Clear glaze (body) · unglazed & ground (relief inlay)",
    firing: "Oxidation firing, 1250°C",
    paletteIndex: 2,
    image: "/works/nebula-cup-l-lavender.png",
    images: [
      "/works/nebula-cup-l-lavender.png",
      "/works/nebula-cup-l-lavender-detail.jpg",
      "/works/nebula-cup-l-lavender-hand.png",
    ],
    category: "CUPS & MUGS",
  },
  {
